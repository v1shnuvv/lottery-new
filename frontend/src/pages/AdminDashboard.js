...
//-----<
//totalwinningvalidation----->
   let url_totalwinningvalidation = "http://localhost:8080/totallotterywinnigtodate";
...
//totalwinningvalidation----->
  axios
  .post(url_totalwinningvalidation, req_totalwinningvalidation, header_totalwinningvalidation)
  .then((res) => {
  ...
  .catch();
  axios
      .post(url_totalwinningvalidation1, req_totalwinningvalidation1, header_totalwinningvalidation1)
      .then((res) => {
